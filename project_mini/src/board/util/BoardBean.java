...
public class BoardBean {
	 ...
	 */
	private int boardPerPage = Constants.BOARDS_PER_PAGE;
	/**
	 ...
	 * @param totalBoards 총 데이터 수
	 * @param page 보려는 페이지.
	 */
	public BoardBean(int totalBoards, int page) {
	 ...
	 * @return
	 */
	public int getBeginBoardInPage(){
		return getEndBoardInPage() - boardPerPage + 1; 
	}
	/**
