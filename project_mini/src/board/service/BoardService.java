...
public interface BoardService {
   ...
   String deleteReferenceService(int boardId);
   ...
   String deleteReferenceMemberService(String memberId);
   
   List<Board> selectBoardTop3Service();
   
   String updateBoardCountService(int boardId);
